...
class ImagesAdapter extends RecyclerView.Adapter<ImagesAdapter.ImagesViewHolder> {
    ...
    public void onBindViewHolder(ImagesViewHolder holder, int position) {
      ...
      //  String idIndex = mCursor.getColumnIndex(_ID);
        ...
        int fragranceName1 = mCursor.getColumnIndex(DbHelper.COLUMN_NAME);// get to the right location in the cursor
        mCursor.moveToPosition(position);

        // Determine the values of the wanted data
        // final int id = mCursor.getInt(idIndex);

        holder.tv.setText(mCursor.getString(fragranceName1)+"");
